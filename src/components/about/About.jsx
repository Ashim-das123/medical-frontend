    ...
    return (
        <section>
            <div className="container">
                ...
                >
                    {/* about image */}
                    <div data-aos="fade-right" data-aos-duration="2000" className='relative w-3/4 lg:w-1/2 xl:w-[770px] z-10 order-2 lg:order-1'>
                    ...
                    {/* about content */}
                    <div data-aos="fade-left" data-aos-duration="2000" className='w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2'>
