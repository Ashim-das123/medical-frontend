    ...
    return (
        <div data-aos="zoom-in" data-aos-duration="2500" className='p-3 lg:p-5'>
            ...
            <div className='mt-2 lg:mt-4 flex items-center justify-between'>
                <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 1g:px-6 text-[12px] leading-4
                ...
                <div className='flex items-center gap-[6px] '>
                    <span className='flex items-center gap-3 text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold
                     text-headingColor'><img src={starIcon} alt="" />
                        {avgRating}</span>
