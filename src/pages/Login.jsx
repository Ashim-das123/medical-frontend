        ...
        <section className='px-5 lg:px-0 '>
            <div className=' w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10'>
                ...
                <form onSubmit={submitHandler} className='py-4 md:py-0  '>
                    ...
                    <div className='mt-7'>
                        <button className='bg-primaryColor text-[18px] leading-30 w-full rounded-lg px-4 py-3 text-white ' type='submit' >
                            {loading ? <ScaleLoader size={25} color='#fff' /> : 'Login'}
                        </button>
                    </div>

                    <p className='mt-5 text-textColor text-center'>
                        Dont't have an account?<Link to="/register" className='text-primaryColor md:text-[14px] font-medium ml-1'> Register</Link>
                    </p>
                </form>
            </div>
        </section>
