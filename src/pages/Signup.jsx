...
const Signup = () => {
    ...
    const handleFileInputChange = async (e) => {
        ...
        // later we will store the img in cloudinary
        // console.log(file);
    }
        ...
        <section className='px-5 xl:px-0 ' >
            <div className='max-w-[970px] mx-auto '>
                <div className='grid gird-cols-1 lg:grid-cols-2 '>
                    {/* img  */}
                    <div className='hidden lg:block bg-primaryColor rounded-l-lg h-[600px]'>
                        <figure>
                        ...
                        <form onSubmit={submitHandler}>
                            ...
                            <div className='mb-5 flex items-center justify-between'>
                                <label className='text-headingColor font-bold text-[16px] leading-7'>
                                    Are you a:<select name="role" className='text-textColor font-semibold text-[15px] leading-7
                            ...
                            <div className='mb-5 flex items-center gap-3'>
                                {selectedFile && <figure className='w-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center
                                  '>
                            ...
                            <div className='mt-7'>
                                <button
                                    ...
                                    type='submit' >
                                    {loading ? <ScaleLoader size={30} color='#ffffff' /> : 'Sign Up'}
                                </button>
                            </div>

                            <p className='mt-5 text-textColor text-center'>
                                Already have an account?<Link to="/login" className='text-primaryColor md:text-[14px] font-medium ml-1'>Login</Link>
                            </p>
