...
const MyBookings = () => {
    ...
    return (
        <div>
            ...
            {
                !loading && !error && appointments.length === 0 && <h2 className="mt-5 text-center text-headingColor
                leading-7 text-[20px] font-semibold">You have not booked any doctor yet!</h2>
            }
