...
const MyAccount = () => {
    ...
    const { data: userData,
        loading,
        error } = useGetProfile(`${BASE_URL}/user/profile/me`)
                    ...
                    !loading && !error && <div className='grid md:grid-cols-3 gap-10'>
                        <div className='pb-[50px] px-[30px] rounded-md'>
                            ...
                            <div className='text-center mt-4'>
                                ...
                                <p className='text-textColor text-[15px] leading-6 font-medium'>Blood Type: <span
                                    className='ml-2 text-headingColor text-[22px] leading-8'>{userData.bloodType}</span></p>
                            </div>
                        ...
                        <div className='md:col-span-2 md:px-[30px]'>
                            <div>
                                ...
                                {/* to use active class use curly with `` */}
