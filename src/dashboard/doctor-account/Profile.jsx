...
const Profile = ({ doctorData }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        ticketPrice: 0,
        qualifications: [
            // { startingDate: "", endingDate: "", degree: "", university: "" }//idx = 0
            // { startingDate: "", endingDate: "", degree: "", university: "" }//idx = 1
        ],
        experiences: [
    ...
    //reusable function to add items

    const addItem = (key, item) => {
        setFormData(prevFormData => ({ ...prevFormData, [key]: [...prevFormData[key], item] }))
    }

    // reusable qulaification input change function
    ...
    //In the expression prevFormData[key].filter((_, i) => i !== index), when iterating over an array of objects like prevFormData[key], the _ parameter represents each individual object in the array, and i represents the index of each object.
        ...
        <div>
            ...
            <form>
                                ...
                                <div className='grid grid-cols-2 gap-5 '>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className='form__input'
                                            onChange={e => handleQualificationChange(e, index)} //index is getting from map and its qualification array
                                        />
                                    </div>
                                    <div>
                ...
                <div className='mb-5'>
                    ...
                    <button onClick={addExperince} className='bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer'>Add Experience</button>
                            ...
                            <div>
                                <div className='grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5 '>
                                    ...
                                    <div className='flex items-center '>
                                       ...
                                       cursor-pointer '><AiOutlineDelete /></button>
                                    </div>
                                </div>
